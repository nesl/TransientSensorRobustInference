...
This Android application integrates the MotionSense platform into mCerebrum's data collection and processing system.
...
For the versions available, see [this repository's tags](https://github.com/MD2Korg/mCerebrum-MotionSense/tags).

## Contributors

Link to the [list of contributors](https://github.com/MD2Korg/mCerebrum-MotionSense/graphs/contributors) who participated in this project.
