package org.md2k.motionsense.eSense;
...
import org.md2k.motionsense.eSense.esenselib.*;
...
public class eSenseController extends AppCompatActivity implements ESenseSensorListener,ESenseConnectionListener, ESenseEventListener {


    //LOG ID
    final private String TAG = "DBG-eSenseController";
    ...
    public void beginTracking(View view) {
        ...
        if (isConnected) {
            ...
            manager = new ESenseManager(devicename,
                    eSenseController.this.getApplicationContext(), this);
